...
describe('attachmentDisposition', () => {
  ...
  it('allows PDFs to render inline without changing their filename', () => {
    const header = inlineDisposition('中文 简历', 'pdf');
    expect(header).toContain('inline; filename="BonCV-resume.pdf"');
    expect(header).toContain("filename*=UTF-8''BonCV-%E4%B8%AD%E6%96%87-%E7%AE%80%E5%8E%86.pdf");
  });
});
